...
Write-Host "3. Inicializando Shard 2 Replica Set (mongo4)..." -ForegroundColor Cyan
docker exec mongo4 mongosh --port 27022 --eval "rs.initiate({_id: 'shard2RS', members: [{_id: 0, host: 'mongo4:27022'}]})"
...
docker exec mongos mongosh --port 27017 --eval "sh.addShard('shard2RS/mongo4:27022')"
